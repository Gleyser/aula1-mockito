...
public class DataUtils {
	...
	/**
	 * Retorna uma Date com os valores passados por parametro
	 * 
	 * @param dia
	 * @param mes
	 * @param ano
	...
	/**
	 * Verifica se uma data eh igual a outra considerando dia, mes e ano
	 * 
	 * @param data1
	 * @param data2
	 * @return
	...
	/**
	 * Verifica se uma determinada data eh o dia da semana desejado
	 * 
